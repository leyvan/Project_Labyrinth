    ...
    */
    ...
    void InstantiatePrefabs()
    {
        ...
        foreach(var floor in floorList)
        {
            ...
            Instantiate(endTeleportPrefab, floorTPs[count]._tp1.transform.position + new Vector3(0, moveTpToFloor, 0), Quaternion.identity, floorSpawnPoints[count].transform.GetChild(0).GetChild(1).transform);
